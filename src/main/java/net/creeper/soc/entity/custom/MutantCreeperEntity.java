...
public class MutantCreeperEntity extends CreeperEntity implements IAnimatable {
    ...
    public MutantCreeperEntity(EntityType<? extends CreeperEntity> entityType, World world) {
